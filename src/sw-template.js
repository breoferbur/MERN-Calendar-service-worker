...
// Post offline
const bgSyncPluginPost = new BackgroundSyncPlugin('post-offline', {
    maxRetentionTime: 24 * 60, // Retry for max of 24 Hours (specified in minutes)
});
// Update offline
const bgSyncPluginUpdate = new BackgroundSyncPlugin('update-offline', {
    maxRetentionTime: 24 * 60, // Retry for max of 24 Hours (specified in minutes)
});
// Delete offline
const bgSyncPluginDelete = new BackgroundSyncPlugin('delete-offline', {
    maxRetentionTime: 24 * 60, // Retry for max of 24 Hours (specified in minutes)
});
